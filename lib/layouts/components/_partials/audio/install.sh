...
# Installation script for audio v1.3.1
# Content Hash: 79d49d2fddc787f1
...
if [ -f "$TARGET_DIR/manifest.json" ]; then
  ...
  if [ "$EXISTING_HASH" = "79d49d2fddc787f1" ]; then
    echo "✓ audio v1.3.1 already installed (no changes)"
    exit 0
  else
