...
# Installation script for flip-card v1.3.1
# Content Hash: cac1588ad6d14aa8
...
echo "🔧 Installing flip-card v1.3.1..."
...
if [ -f "$TARGET_DIR/manifest.json" ]; then
  ...
  if [ "$EXISTING_HASH" = "cac1588ad6d14aa8" ]; then
    echo "✓ flip-card v1.3.1 already installed (no changes)"
    exit 0
  else
