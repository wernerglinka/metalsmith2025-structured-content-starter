...
# Installation script for collection-pagination v1.4.0
# Content Hash: 4293dbae3812bb2d
...
echo "🔧 Installing collection-pagination v1.4.0..."
...
if [ -f "$TARGET_DIR/manifest.json" ]; then
  ...
  if [ "$EXISTING_HASH" = "4293dbae3812bb2d" ]; then
    echo "✓ collection-pagination v1.4.0 already installed (no changes)"
    exit 0
  else
