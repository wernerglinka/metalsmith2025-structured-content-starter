...
# Installation script for text v1.4.0
# Content Hash: 1af622f2963f25fc
...
if [ -f "$TARGET_DIR/manifest.json" ]; then
  ...
  if [ "$EXISTING_HASH" = "1af622f2963f25fc" ]; then
    echo "✓ text v1.4.0 already installed (no changes)"
    exit 0
  else
