...
# Installation script for iframe v1.3.1
# Content Hash: f1e15e187de9487d
...
if [ -f "$TARGET_DIR/manifest.json" ]; then
  ...
  if [ "$EXISTING_HASH" = "f1e15e187de9487d" ]; then
    echo "✓ iframe v1.3.1 already installed (no changes)"
    exit 0
  else
