...
```bash
cp podcast.njk your-project/lib/layouts/components/sections/podcast/
cp podcast.css your-project/lib/layouts/components/sections/podcast/
cp podcast.js your-project/lib/layouts/components/sections/podcast/
cp manifest.json your-project/lib/layouts/components/sections/podcast/
```

## Usage

Add the podcast section to your page frontmatter:

### Basic Example

Minimal podcast configuration
...
https://metalsmith-components.netlify.app/library/podcast/
