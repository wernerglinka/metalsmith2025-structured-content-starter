...
- [slider-pagination](../partials/slider-pagination-v0.0.1.zip)
...
```bash
cp slider.njk your-project/lib/layouts/components/sections/slider/
cp slider.css your-project/lib/layouts/components/sections/slider/
cp slider.js your-project/lib/layouts/components/sections/slider/
cp manifest.json your-project/lib/layouts/components/sections/slider/
```

## Usage

Add the slider section to your page frontmatter:

### Basic Example

Minimal slider configuration
...
https://metalsmith-components.netlify.app/library/slider/
