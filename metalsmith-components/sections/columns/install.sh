...
# Installation script for columns v0.0.1
# Content Hash: 4f03e77aa18d3c4a

set -e

echo "🔧 Installing columns v0.0.1..."
...
if [ -f "$TARGET_DIR/manifest.json" ]; then
  ...
  if [ "$EXISTING_HASH" = "4f03e77aa18d3c4a" ]; then
    echo "✓ columns v0.0.1 already installed (no changes)"
    exit 0
  else
