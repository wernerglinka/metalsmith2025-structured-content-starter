...
```bash
cp audio-only.njk your-project/lib/layouts/components/sections/audio-only/
cp audio-only.css your-project/lib/layouts/components/sections/audio-only/
cp manifest.json your-project/lib/layouts/components/sections/audio-only/
```

## Usage

Add the audio-only section to your page frontmatter:
...
https://metalsmith-components.netlify.app/library/audio-only/
