...
# Installation script for multi-media v0.0.1
# Content Hash: c8a7e87dbeec42f3

set -e

echo "🔧 Installing multi-media v0.0.1..."
...
if [ -f "$TARGET_DIR/manifest.json" ]; then
  ...
  if [ "$EXISTING_HASH" = "c8a7e87dbeec42f3" ]; then
    echo "✓ multi-media v0.0.1 already installed (no changes)"
    exit 0
  else
