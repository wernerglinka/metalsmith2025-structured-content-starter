...
# Installation script for commons v0.0.1
# Content Hash: e41f3eca65589cb9

set -e

echo "🔧 Installing commons v0.0.1..."
...
if [ -f "$TARGET_DIR/manifest.json" ]; then
  ...
  if [ "$EXISTING_HASH" = "e41f3eca65589cb9" ]; then
    echo "✓ commons v0.0.1 already installed (no changes)"
    exit 0
  else
