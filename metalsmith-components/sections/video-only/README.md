...
```bash
cp video-only.njk your-project/lib/layouts/components/sections/video-only/
cp video-only.css your-project/lib/layouts/components/sections/video-only/
cp video-only.js your-project/lib/layouts/components/sections/video-only/
cp manifest.json your-project/lib/layouts/components/sections/video-only/
```

## Usage

Add the video-only section to your page frontmatter:

### Basic Example

Minimal video-only configuration
...
https://metalsmith-components.netlify.app/library/video-only/
