...
```bash
cp blog-author.njk your-project/lib/layouts/components/sections/blog-author/
cp blog-author.css your-project/lib/layouts/components/sections/blog-author/
cp manifest.json your-project/lib/layouts/components/sections/blog-author/
```

## Usage

Add the blog-author section to your page frontmatter:

### Basic Example

Minimal blog-author configuration
...
https://metalsmith-components.netlify.app/library/blog-author/
