...
# Installation script for collection-card v0.0.1
# Content Hash: 85dbe43f04d3145b

set -e

echo "🔧 Installing collection-card v0.0.1..."
...
if [ -f "$TARGET_DIR/manifest.json" ]; then
  ...
  if [ "$EXISTING_HASH" = "85dbe43f04d3145b" ]; then
    echo "✓ collection-card v0.0.1 already installed (no changes)"
    exit 0
  else
...
# Check for author-date in both partials and sections
