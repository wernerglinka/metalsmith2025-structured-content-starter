...
```bash
cp text.njk your-project/lib/layouts/components/_partials/text/
cp text.css your-project/lib/layouts/components/_partials/text/
cp manifest.json your-project/lib/layouts/components/_partials/text/
```

## More Information

For complete documentation and live examples, visit:
https://metalsmith-components.netlify.app/references/partials/text/
