...
# Installation script for overlay v0.0.1
# Content Hash: 27e5dcc1550adc21

set -e

echo "🔧 Installing overlay v0.0.1..."
...
if [ -f "$TARGET_DIR/manifest.json" ]; then
  ...
  if [ "$EXISTING_HASH" = "27e5dcc1550adc21" ]; then
    echo "✓ overlay v0.0.1 already installed (no changes)"
    exit 0
  else
