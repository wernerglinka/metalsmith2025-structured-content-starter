...
```bash
cp flip-card.njk your-project/lib/layouts/components/_partials/flip-card/
cp flip-card.css your-project/lib/layouts/components/_partials/flip-card/
cp flip-card.js your-project/lib/layouts/components/_partials/flip-card/
cp manifest.json your-project/lib/layouts/components/_partials/flip-card/
```

## More Information

For complete documentation and live examples, visit:
https://metalsmith-components.netlify.app/references/partials/flip-card/
