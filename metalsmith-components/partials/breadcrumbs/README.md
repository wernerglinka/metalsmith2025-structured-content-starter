...
```bash
cp breadcrumbs.njk your-project/lib/layouts/components/_partials/breadcrumbs/
cp breadcrumbs.css your-project/lib/layouts/components/_partials/breadcrumbs/
cp manifest.json your-project/lib/layouts/components/_partials/breadcrumbs/
```

## More Information

For complete documentation and live examples, visit:
https://metalsmith-components.netlify.app/references/partials/breadcrumbs/
