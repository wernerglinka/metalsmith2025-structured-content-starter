...
# Installation script for button v0.0.1
# Content Hash: cd646c5c5c139c3a

set -e

echo "🔧 Installing button v0.0.1..."
...
if [ -f "$TARGET_DIR/manifest.json" ]; then
  ...
  if [ "$EXISTING_HASH" = "cd646c5c5c139c3a" ]; then
    echo "✓ button v0.0.1 already installed (no changes)"
    exit 0
  else
