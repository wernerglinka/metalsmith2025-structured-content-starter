...
```bash
cp icon.njk your-project/lib/layouts/components/_partials/icon/
cp manifest.json your-project/lib/layouts/components/_partials/icon/
```

## More Information

For complete documentation and live examples, visit:
https://metalsmith-components.netlify.app/references/partials/icon/
