...
# Installation script for text-link v0.0.1
# Content Hash: 9d39084a1773cf86

set -e

echo "🔧 Installing text-link v0.0.1..."
...
if [ -f "$TARGET_DIR/manifest.json" ]; then
  ...
  if [ "$EXISTING_HASH" = "9d39084a1773cf86" ]; then
    echo "✓ text-link v0.0.1 already installed (no changes)"
    exit 0
  else
